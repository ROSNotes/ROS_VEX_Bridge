...
"""
    A ROS Node for the VEX microcontroller
...
import rospy
from ROS_VEX_python.VEX_driver import VEX
from ROS_VEX_python.VEX_sensors import *
from ROS_VEX_msgs.srv import *
from ROS_VEX_python.base_controller import BaseController
...
class VEXROS():
    def __init__(self):
        rospy.init_node('VEX', log_level=rospy.INFO)
        ...
        self.controller = VEX(self.port, self.baud, self.timeout, self.motors_reversed)

        # Make the connection
        self.controller.connect()

        rospy.loginfo("Connected to VEX on port " + self.port + " at " + str(self.baud) + " baud")
...
#                    self.sensors[len(self.sensors)]['output_pin'] = params['output_pin']
    ...
    def shutdown(self):
        rospy.loginfo("Shutting down VEX Node...")
